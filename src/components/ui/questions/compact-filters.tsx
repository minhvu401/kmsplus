...
export default function CompactFilters({ categories }: CompactFiltersProps) {
  ...
  useEffect(() => {
    const active = category !== 'any' || status !== 'any' || sort !== 'newest' || searchParams.has('query');
    ...
    >
      ...
      <select
        ...
        style={{
          ...
          cursor: 'pointer',
          transition: 'all 0.2s',
          borderColor: category !== 'any' ? '#2563eb' : '#e5e7eb',
          flex: '1 1 auto',
          minWidth: '120px',
        }}
        onMouseEnter={(e) => {
        ...
        onMouseLeave={(e) => {
          e.currentTarget.style.borderColor = category !== 'any' ? '#2563eb' : '#e5e7eb';
        }}
      ...
      <select
        ...
        onMouseLeave={(e) => {
          e.currentTarget.style.borderColor = status !== 'any' ? '#2563eb' : '#e5e7eb';
        }}
