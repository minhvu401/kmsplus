...
export const en = {
  ...
  "article.comments_empty": "No comments yet. Be the first to comment!",
  ...
  "article.form_thumbnail_button": "Upload Image",
  ...
  "article.form_title_required": "Please enter a title",
  "article.form_title_length": "Title must be less than 150 characters",
  ...
  "article.form_thumbnail_error_size":
    "Thumbnail image exceeds {size}MB. Please choose a smaller image.",
  "article.form_content_label": "Content",
  "article.form_content_placeholder": "Write article content...",
  "article.form_content_required": "Please enter content",
  "article.form_content_length": "Content must be less than 5000 characters",
  "article.form_content_max": "/ 5,000",
  "article.form_category_label": "Category",
  "article.form_category_placeholder": "Select a category",
  ...
  "article.form_tags_max": "Max {count} tags",
  ...
  "article.form_btn_publish": "Publish",
  "article.form_btn_submit_for_review": "Submit for Review",
  "article.form_admin_publish_tooltip":
    "Only Admin can publish. Your article will be pending for approval.",
  ...
  // Course page
  "course.by": "By",
  "course.unknown_creator": "Unknown creator",
  "course.students": "students",
  "course.no_media": "No media",
  "course.duration_label": "Course Duration",
  "course.hours_unit": "hours",
  "course.your_progress": "Your Progress",
  "course.continue_learning": "Continue Learning",
  "course.tab_overview": "Overview",
  "course.description_title": "Description",
  "course.no_description": "No description provided.",
  "course.tab_curriculum": "Curriculum",
  "course.curriculum_title": "Curriculum",
  "course.tab_instructor": "Instructor",
  "course.instructor_title": "Course instructor",
  "course.no_email": "No email",
  "course.related_courses": "Related Courses",
  "course.related_none": "No related courses.",
  ...
  "learning.reset_success": "Course progress has been reset.",
  "learning.quiz_not_available": "Quiz details are not available.",
  "learning.course_content": "Course Content",
  "learning.loading_content": "Loading content...",
  "learning.pdf_document": "PDF Document",
  "learning.view_pdf_desc":
    "View the PDF document below. You can download it using the button in the top-right corner.",
  "learning.lesson": "Lesson",
  "learning.quiz": "Quiz",
  "learning.no_content": "This course has no content.",
  "learning.min": "min",
  "learning.questions": "questions",
  "learning.completed_label": "Completed",
  "learning.mark_complete": "Mark as Complete",
  "learning.complete_success": "Great job! Course progress: {0}%",
  "learning.update_failed": "Failed to update progress",
  "learning.something_wrong": "Something went wrong",
  ...
  "course.enroll_success_header": "Success!",
  "course.enroll_success_prefix": "You have successfully enrolled in",
  "course.enroll_go_to_learning": "Go to Learning →",
  "course.enroll_later": "Later",
  ...
  "course.assignment.title": "Mandatory Assignment",
  "course.assignment.description":
    "Require specific groups to take this course.",
  "course.assignment.btn_add": "Add Rule",
  "course.assignment.target_type": "Target Type",
  "course.assignment.target_all_employees": "All Employees",
  "course.assignment.target_department": "Department",
  "course.assignment.target_role": "Role",
  "course.assignment.target_user": "User",
  "course.assignment.search_users": "Search users...",
  "course.assignment.whole_company": "Whole Company",
  "course.assignment.due_label": "Due:",
  "course.assignment.due_none": "None",
  "course.assignment.due_relative": "Days",
  "course.assignment.due_fixed": "Fixed",
  "course.assignment.due_unit": "days",
  "course.assignment.due_no_deadline": "No deadline",
  "course.assignment.due_invalid": "Please select a future date",
  "course.assignment.select_department": "Select Department...",
  "course.assignment.select_role": "Select Role...",
  "course.assignment.role_manager": "Manager",
  "course.assignment.role_staff": "Staff",
  "course.assignment.no_rules_set": "No mandatory rules have been set yet.",
