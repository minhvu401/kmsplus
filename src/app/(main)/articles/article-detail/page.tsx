...
const mockArticleDetail = {
  ...
  imageUrl:
    "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=800&fit=crop",
  author: {
    name: "Nguyễn Văn A",
...
const mockRelatedArticles = [
  ...
  {
    id: 2,
    title: "Một bài viết liên quan khác",
    category: "Technical",
    date: "21/10/2025",
  },
  {
    id: 3,
    title: "Khám phá mới về vũ trụ",
    category: "News",
    date: "20/10/2025",
  },
]
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-sm p-6 lg:p-10">
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed text-base">
              ...
              <p>
                Một hòn đá có khối lượng đều tạo ra lực hấp dẫn, và lực này hút
                mọi vật chất khác về phía nó.
              </p>
              <ul className="list-disc list-inside space-y-2 pl-4">
                <li>
                  <strong>Sự hình thành ban đầu:</strong> Khoảng 4.5 tỷ năm
                  trước...
                </li>
                <li>
                  <strong>Vật chất bị nén chặt:</strong> Khi khối vật chất này
                  ngày càng lớn dần...
                </li>
                <li>
                  <strong>Hình cầu là kết quả tự nhiên:</strong> Hình dạng duy
                  nhất...
                </li>
              </ul>
              <p>Ví dụ dễ hiểu: Một giọt nước lơ lửng trong không gian...</p>
              <h2 className="text-xl font-semibold text-gray-800 mt-4">
                2. Trái Đất không phải là một hình cầu hoàn hảo
              </h2>
              <p>Mặc dù chúng ta nói Trái Đất hình tròn...</p>
              <h2 className="text-xl font-semibold text-gray-800 mt-4">
                3. Vậy còn núi và vực thẳm thì sao?
              </h2>
              <p>Bạn có thể thắc mắc...</p>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-2">
                    {mockArticleDetail.author.role}
                  </p>

                  {mockArticleDetail.author.tags &&
                    mockArticleDetail.author.tags.includes("Staff") && (
                ...
                {mockRelatedArticles.map((article, index) => (
                  ...
                  <React.Fragment key={article.id}>
                    ...
                    <div className="py-2">
                      ...
                      <a
                        href="#"
                        className="text-sm font-medium text-gray-700 hover:text-blue-600 leading-tight"
                      >
                        {article.title}
                      </a>
