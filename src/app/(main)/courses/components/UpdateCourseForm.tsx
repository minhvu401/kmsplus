...
export type AssignmentRulePayload = {
  ...
  user_id?: number | null
  role_id?: number | null
  due_type: "relative" | "fixed" | "none" | null
    ...
    setPayload((prev) => {
      ...
      if (activeSectionId === overSectionId) {
        ...
        const [movedItem] = sourceItems.splice(
          sourceItems.findIndex((i) => i.id === activeId),
          1
        )
        ...
        <div className="pb-4">
          {current === 0 && (
            <section className="space-y-6">
              ...
              {/* --- CẤU HÌNH HIỂN THỊ & QUY TẮC (GỌN GÀNG) --- */}
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {/* CỘT TRÁI: VISIBILITY (Đã bỏ Hạn Mặc Định) */}
                  ...
                  {/* CỘT PHẢI: ASSIGNMENT RULES (Sửa tên thành số 2) */}
