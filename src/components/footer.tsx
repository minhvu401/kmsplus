  ...
  return (
    <footer className="flex flex-col sm:flex-row items-center justify-between border-t mt-12 pt-6 text-sm text-gray-500">
      <div className="flex items-center gap-2">
        <img src="/logo.png" alt="KMSPlus Logo" className="h-6 w-auto object-contain" />
        <p>© 2026 - <span className="font-semibold">KMSPlus</span>. Designed by <span className="font-semibold">KMS Team</span>. All rights reserved.</p>
      </div>
