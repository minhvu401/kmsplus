...
export const TopAuthors: React.FC<TopAuthorsProps> = ({
  authors,
  isLoading = false,
}) => {
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <h3 className="text-sm font-bold text-gray-900 mb-4">
          {t("article.featured_authors_title", language)}
        </h3>
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 sticky top-20">
        ...
        <p className="text-sm text-gray-500 text-center py-6">
          {t("article.featured_authors_empty", language)}
        </p>
      </div>
    )
  }
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500">
                  {t(
                    "article.featured_authors_article_count",
                    language
                  ).replace("{count}", String(author.articleCount))}
                </p>
              </div>
